        ...
        Column(
            ...
            Row(
                ...
                Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                    TextButton(onClick = { showManualIpDialog = true }) { Text(text = "Manual IP") }
                    TextButton(onClick = { showQrDialog = true }) { Text(text = "Show QR Code") }
                }
            }
        }
    }
    ...
    Card(
        ...
        Column(
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(6.dp)) {
                ...
                if (entry.isTrusted)
                        BadgeChip(label = "★", background = MaterialTheme.colorScheme.tertiary)
            }
        }
    }
}
...
private fun BadgeChip(
    ...
    Box(
            modifier =
                    Modifier.background(color = background, shape = MaterialTheme.shapes.small)
