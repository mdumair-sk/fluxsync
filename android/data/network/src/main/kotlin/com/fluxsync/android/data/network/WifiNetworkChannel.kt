...
class WifiNetworkChannel(
    ...
    // TCP send-buffer occupancy is managed by the kernel and is not directly observable for
    // java.net.Socket.
    override val sendBufferFillFraction: Float = 0f

    private val throughputTracker = ThroughputTracker()
    private val writeMutex = Mutex()
    private val sendBuffer =
            ByteBuffer.allocateDirect(ChunkPacketCodec.HEADER_SIZE + MAX_CHUNK_SIZE)
